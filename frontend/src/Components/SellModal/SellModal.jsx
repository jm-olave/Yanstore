...
const SellModal = ({PAYMENT_METHODS, selectedProduct, setSaleData, saleData, handleSell, setSellModalOpen}) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg w-full max-w-md shadow-lg">
        <h2 className="text-4xl font-bold mb-4 text-mainBlue">Sell {selectedProduct.name}</h2>
        ...
        <div className="space-y-4">
          ...
          <InputSelect
            ...
            value={saleData.payment_method}
            onChange={(e) => setSaleData(prevData => ({...prevData, payment_method: e.target.value}))}
